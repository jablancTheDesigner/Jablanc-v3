...
export default function SingleProject() {
  ...
  const [project, setProject] = useState<JBProject>(
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <div className="text-white flex flex-col text-left w-full col-span-2 justify-center p-4">
              ...
              <div className="capitalize text-primary grid grid-cols-2 gap-2 my-auto">
                {project?.tools.html && (
                  <p className="text-xl inline-flex gap-1 items-center">
                    <DiHtml5 /> HTML
                  </p>
                )}
                {project?.tools.sass && (
                ...
                {project?.tools.angular && (
                  <p className="text-xl inline-flex gap-1 items-center">
                    <DiAngularSimple /> Angular 2+
                  </p>
                )}
                {project?.tools.js && (
                  <p className="text-xl inline-flex gap-1 items-center">
                ...
                {project?.tools.photoshop && (
                  <p className="text-xl inline-flex gap-1 items-center">
                    <DiPhotoshop /> Photoshop
                  </p>
                )}
                {project?.tools.illustrator && (
                  <p className="text-xl inline-flex gap-1 items-center">
                    <DiIllustrator /> Illustrator
                  </p>
                )}
