        ...
        <header>
            <nav className="flex w-full fixed left-1/2 right-0 h-[var(--nav-height)] text-dark p-0 z-[99] -translate-x-1/2">
                    <Link href="/">
                            ...
                            <svg className="w-[35px] h-auto mx-auto"
                                width={48} 
                                height={48} 
                                viewBox="0 0 50 48" 
                ...
                <div className="relative flex ml-auto">
                    <button className="app-button w-16 m-auto relative z-[9] appearance-none cursor-pointer opacity-100 !px-4 py-0 flex h-full items-center justify-center text-center hover:opacity-80 fill-primary"
                            onClick={()=> setOpen(!open)}>
                                {!open && <svg width="46" height="22" viewBox="0 0 46 22" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="46" height="6" rx="3" />
                                    <rect x="19.0944" y="16" width="26.9057" height="6" rx="3" />
                                </svg>}
                                {open && <svg width="29" height="28" viewBox="0 0 29 28" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="12.0001" y="13.5456" width="19.1563" height="4.27119" rx="2.13559" transform="rotate(-45 12.0001 13.5456)" />
                                    <rect x="15.0203" y="10.6833" width="19.1563" height="4.27119" rx="2.13559" transform="rotate(45 15.0203 10.6833)"/>
                                    <rect x="16.5657" y="13.7034" width="19.1563" height="4.27119" rx="2.13559" transform="rotate(135 16.5657 13.7034)" />
                                    <rect x="13.5455" y="16.5657" width="19.1563" height="4.27119" rx="2.13559" transform="rotate(-135 13.5455 16.5657)" />
                                </svg>}
                    </button>
                </div>
            </nav>
                    ...
                    <div className="-mt-[var(--nav-height)] flex flex-col max-w-2xl mx-auto">
                        {links.map( (link, index) => {
                            return <Link href={link.url} key={index}>
                                <a className="app-button app-button--primary md:text-5xl lg:text-6xl text-4xl !text-dark hover:!text-white !font-bold" 
